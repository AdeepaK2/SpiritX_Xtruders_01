...
export default function LoginPage() {
  ...
  // Add this state near the other state declarations in LoginPage component
        ...
        >
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">You have successfully logged in.</p>
